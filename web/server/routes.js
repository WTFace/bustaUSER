...
module.exports = function(app) {
    ...
    app.get('/login', staticPageLogged('login', '/chknote'));
    ...
    app.get('/deposit/request', restrict, user.depositRequest);
    app.get('/support', restrict, user.supports);
    app.get('/support/write', restrict, user.supportwrite);
    app.get('/note', restrict, user.note);
    app.get('/note/confirm', restrict, user.confnote);
    app.get('/chknote', restrict, user.chknote);
    ...
    app.get('/notice', staticPageLogged('faq'));
    ...
    app.post('/support', restrict, user.contacthandle);
    ...
    // Admin stuff
    app.get('/cashdev', adminRestrict, admin.giveAway);
    app.post('/cashdev', adminRestrict, admin.giveAwayHandle);
