define([
    ...
    var ControlsStore = _.extend({}, Events, {
        ...
        _addBetSize: function(betSize) {
            ...
            let before = Clib.parseBet(_betSize);
            let after = before + bet;
            _betSize = after.toString();
    ...
    AppDispatcher.register(function(payload) {
        ...
        switch(action.actionType) {
            ...
            case AppConstants.ActionTypes.ADD_BET_SIZE:
                ControlsStore._addBetSize(action.betSize);
                ControlsStore.emitChange();
                break;
